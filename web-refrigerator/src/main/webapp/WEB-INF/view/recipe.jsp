      ...
      <div class="form-group">
        ...
        <div class="col-md-6 inputGroupContainer">
          <div class="input-group">
            ...
            <input  name="recipename" placeholder="Name" class="form-control"  type="text">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 inputGroupContainer">
          <div class="input-group">
            ...
            <input  name="timerecipe" placeholder="Time" class="form-control"  type="time">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 inputGroupContainer">
          <div class="input-group">
            ...
            <input  name="cookingmethod" placeholder="Cooking Method" class="form-control"  type="text">
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 inputGroupContainer">
          <div class="input-group">
            ...
            <select name="complexity" class="form-control" id="complexityopts">
              ${complexityoptions}
            </select>
          </div>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 inputGroupContainer">
          <div class="input-group">
            ...
            <textarea id="instructionstextarea" name="instructions" placeholder="Instructions" class="form-control"></textarea>
          </div>
        </div>
      </div>
